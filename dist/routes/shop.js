...
exports.router.get('/', shopController.getIndex);
exports.router.get('/products', shopController.getProducts);
exports.router.get('/products/:productId', shopController.getProduct);
